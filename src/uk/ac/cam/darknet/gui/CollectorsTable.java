 ...
 * 
 */
public class CollectorsTable extends JTable {
	private static final long serialVersionUID = 1L;
	// Names of the columns in the table
	private static final String[] columns = { "Use?", "Collector name" };
	 ...
	 */
	public void addCollector(final String collectorName) {
		// Add row to the table
		model.addRow(new Object[] { new Boolean(false), collectorName });
	}
